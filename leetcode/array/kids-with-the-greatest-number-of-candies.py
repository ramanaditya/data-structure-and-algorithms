...
class Solution:
    def kidsWithCandies(self, candies: List[int], extraCandies: int) -> List[bool]:
        ...
        res = [
            True if candy + extraCandies >= maxCandies else False for candy in candies
        ]
        return res


# Runtime       : 32 ms, faster than 95.01% of Python3 online submissions
# Memory Usage  : 13.8 MB, less than 78.98% of Python3 online submissions
